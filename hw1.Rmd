...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: My name is **Mario** and I am a *biology* major. I also have two minors, data science and sustainability. I have done some coding in python but this is my first time using R. I grew up in Seattle Washington, but most of my family is from Portugal so I spent a lot of time abroad as well.
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: Data entry is not a job with any glamour, but it is just as vital as any heroic job you can think of. Data entry is where someone sits at their desk and spends their day copying data recorded on paper and inputs that data into their computer. Now the data can be shared and used on other computers anywhere in the world. 
    
    https://en.wikipedia.org/wiki/Data_entry_clerk
    
    ```
    !Data Entry(~/ds202_hw1)
    
    ![Data Entry](https://hopla.online/wp-content/uploads/sites/2/2018/09/data-entry-specialist-for-hire.jpg)
    
    ![Data Entry](HW1_image.jpg)
    
    Neither of these ways worked so I deleted the code block designation ({r}) so that it would knit but I could still show my work.
    ```
